...
using Hypesoft.Application.TodoItems.Commands.CreateTodoItem;
using Hypesoft.Application.TodoItems.Commands.DeleteTodoItem;
using Hypesoft.Application.TodoItems.Commands.UpdateTodoItem;
using Hypesoft.Application.TodoItems.Commands.UpdateTodoItemDetail;
using Hypesoft.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace Hypesoft.Web.Endpoints;
